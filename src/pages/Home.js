...
import imgCSAPMort from "../assets/graphs/fig_csap_mortalidade.png";
import imgCSAPInternacoes from "../assets/graphs/fig_csap_internacoes.png";
          ...
          <Card>
            <Card.Body>
              <Card.Title className="text-center">
                ...
                <span class="ef-title-graphs">PROCESSOS</span>
              </Card.Title>
              <Row>
                <Col md={6}>
                  <img
        ...
        <Col md={12} className="mb-4">
          <Card>
            <Card.Body>
              <Card.Title className="text-center">
                Evolução da eficiência de{" "}
                <span class="ef-title-graphs">RESULTADOS</span>
              </Card.Title>
              <Row>
                <Col md={6}>
                  <img
